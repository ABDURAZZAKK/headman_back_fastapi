...
# @pytest.mark.asyncio
# async def test_create_user(get_all):
#     a = await get_all
#     print(a)
#     user_data = {
#         "name": "Nikolai",
...
#         "password2": "Qwerty123",
#     }
#     resp = client.post("api/users/", data=json.dumps(user_data))
#     data_from_resp = resp.json()
#     assert resp.status_code == 200
#     assert data_from_resp["name"] == user_data["name"]
#     assert verify_password("Qwerty123", data_from_resp["hashed_password"])
#     assert data_from_resp["email"] == user_data["email"]

#     users_from_db = get_all()
...
#     resp = client.delete(f"/user/?id={user_data['id']}")
#     assert resp.status_code == 200
